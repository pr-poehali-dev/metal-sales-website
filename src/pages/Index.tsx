...
const CATALOG_CATEGORIES = [
  ...
  { id: "fastener", label: "Метизы" },
  { id: "color", label: "Цветной прокат" },
...
const PRODUCTS = [
  ...
  { id: 3, category: "sheet", name: "Лист оцинкованный", spec: "ст08пс, ГОСТ 14918-80", sizes: "0.5–3 мм × 1000–1250 мм", price: "от 96 000 ₽/т", tag: "" },
  { id: 4, category: "sheet", name: "Лист рифлёный", spec: "ст3сп, ГОСТ 8568-77", sizes: "4–12 мм × 1500–2000 мм", price: "от 74 500 ₽/т", tag: "" },
  { id: 5, category: "sheet", name: "Лист конструкционный", spec: "09Г2С, ГОСТ 19903-2015", sizes: "4–60 мм × 1500–2500 мм", price: "от 79 000 ₽/т", tag: "" },
  { id: 6, category: "sheet", name: "Лист нагартованный", spec: "08кп, ГОСТ 19904-2012", sizes: "0.5–2 мм × 1000–2000 мм", price: "от 88 000 ₽/т", tag: "" },
  // Трубы
  { id: 7, category: "pipe", name: "Труба круглая бесшовная", spec: "ст20, ГОСТ 8732-78", sizes: "Ø 25–325 мм", price: "от 74 000 ₽/т", tag: "Популярно" },
  { id: 8, category: "pipe", name: "Труба профильная", spec: "ст3сп, ГОСТ 8645-68", sizes: "20×20 – 200×200 мм", price: "от 71 000 ₽/т", tag: "" },
  { id: 9, category: "pipe", name: "Труба водогазопроводная", spec: "ст3сп, ГОСТ 3262-75", sizes: "Ø 15–150 мм, длина 6–12 м", price: "от 67 500 ₽/т", tag: "" },
  { id: 10, category: "pipe", name: "Труба электросварная", spec: "ст3сп, ГОСТ 10705-80", sizes: "Ø 20–530 мм", price: "от 69 000 ₽/т", tag: "" },
  { id: 11, category: "pipe", name: "Труба прямоугольная", spec: "ст3сп, ГОСТ 8645-68", sizes: "40×20 – 250×150 мм", price: "от 72 000 ₽/т", tag: "" },
  { id: 12, category: "pipe", name: "Труба котельная", spec: "12Х1МФ, ГОСТ 550-75", sizes: "Ø 32–219 мм", price: "от 115 000 ₽/т", tag: "" },
  // Балки и швеллер
  { id: 13, category: "beam", name: "Двутавровая балка", spec: "ст3сп5, ГОСТ 8239-89", sizes: "Б10–Б60, длина 6–12 м", price: "от 72 500 ₽/т", tag: "" },
  { id: 14, category: "beam", name: "Швеллер", spec: "ст3сп, ГОСТ 8240-97", sizes: "5П–40П, длина 6–12 м", price: "от 73 000 ₽/т", tag: "" },
  { id: 15, category: "beam", name: "Балка широкополочная", spec: "ст3сп, ГОСТ 26020-83", sizes: "20Ш–100Ш, длина 6–12 м", price: "от 75 000 ₽/т", tag: "" },
  { id: 16, category: "beam", name: "Швеллер гнутый", spec: "ст3сп, ГОСТ 8281-80", sizes: "80×40 – 300×100 мм", price: "от 78 000 ₽/т", tag: "" },
  { id: 17, category: "beam", name: "Балка двутавровая колонная", spec: "ст3сп5, ГОСТ 26020-83", sizes: "К20–К40, длина 6–12 м", price: "от 76 000 ₽/т", tag: "" },
  { id: 18, category: "beam", name: "Профиль Z-образный", spec: "ст3сп, ГОСТ 19425-74", sizes: "100–300 мм, длина 6–12 м", price: "от 74 000 ₽/т", tag: "" },
  // Уголок
  { id: 19, category: "angle", name: "Уголок равнополочный", spec: "ст3сп, ГОСТ 8509-93", sizes: "20×3 – 200×20 мм", price: "от 70 000 ₽/т", tag: "Популярно" },
  { id: 20, category: "angle", name: "Уголок неравнополочный", spec: "ст3сп, ГОСТ 8510-86", sizes: "40×25 – 200×125 мм", price: "от 71 500 ₽/т", tag: "" },
  { id: 21, category: "angle", name: "Уголок гнутый", spec: "ст3сп, ГОСТ 19771-93", sizes: "20×20 – 150×150 мм", price: "от 73 000 ₽/т", tag: "" },
  // Арматура и прут
  { id: 22, category: "rod", name: "Арматура рифлёная", spec: "А500С, ГОСТ 52544-2006", sizes: "Ø 6–40 мм, длина 11.7 м", price: "от 63 000 ₽/т", tag: "Акция" },
  { id: 23, category: "rod", name: "Прут круглый", spec: "ст3сп, ГОСТ 2590-2006", sizes: "Ø 6–300 мм, длина 6–12 м", price: "от 66 000 ₽/т", tag: "" },
  { id: 24, category: "rod", name: "Прут квадратный", spec: "ст3сп, ГОСТ 2591-2006", sizes: "10×10 – 200×200 мм", price: "от 67 000 ₽/т", tag: "" },
  { id: 25, category: "rod", name: "Шестигранник", spec: "ст3сп, ГОСТ 2879-2006", sizes: "6–100 мм, длина 6–12 м", price: "от 69 000 ₽/т", tag: "" },
  { id: 26, category: "rod", name: "Арматура гладкая А1", spec: "А240, ГОСТ 5781-82", sizes: "Ø 6–40 мм, длина 11.7 м", price: "от 60 000 ₽/т", tag: "" },
  // Профлист
  { id: 27, category: "proflist", name: "Профлист С8", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.45–0.7 мм, ширина 1150 мм", price: "от 490 ₽/м²", tag: "Популярно" },
  { id: 28, category: "proflist", name: "Профлист С10", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.45–0.7 мм, ширина 1150 мм", price: "от 510 ₽/м²", tag: "" },
  { id: 29, category: "proflist", name: "Профлист С20", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.5–0.8 мм, ширина 1100 мм", price: "от 540 ₽/м²", tag: "" },
  { id: 30, category: "proflist", name: "Профлист НС35", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.5–0.9 мм, ширина 1000 мм", price: "от 580 ₽/м²", tag: "" },
  { id: 31, category: "proflist", name: "Профлист Н60", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.7–1.0 мм, ширина 845 мм", price: "от 690 ₽/м²", tag: "" },
  { id: 32, category: "proflist", name: "Профлист Н75", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.7–1.2 мм, ширина 750 мм", price: "от 780 ₽/м²", tag: "" },
  { id: 33, category: "proflist", name: "Профлист оцинкованный С8", spec: "ГОСТ Р 58933-2020", sizes: "толщ. 0.45–0.55 мм, ширина 1150 мм", price: "от 460 ₽/м²", tag: "Акция" },
  // Метизы
  { id: 34, category: "fastener", name: "Болт с шестигранной головкой", spec: "кл. пр. 5.8, ГОСТ 7798-70", sizes: "М6–М48, длина 20–300 мм", price: "от 85 ₽/кг", tag: "" },
  { id: 35, category: "fastener", name: "Гайка шестигранная", spec: "кл. пр. 5, ГОСТ 5915-70", sizes: "М6–М48", price: "от 90 ₽/кг", tag: "" },
  { id: 36, category: "fastener", name: "Шайба плоская", spec: "кл. пр. А, ГОСТ 11371-78", sizes: "М6–М48", price: "от 80 ₽/кг", tag: "" },
  { id: 37, category: "fastener", name: "Шпилька резьбовая", spec: "кл. пр. 5.8, ГОСТ 22042-76", sizes: "М6–М48, длина 0.5–3 м", price: "от 95 ₽/кг", tag: "" },
  { id: 38, category: "fastener", name: "Анкер-клин", spec: "сталь оцинк., ГОСТ Р 50171", sizes: "М8–М24", price: "от 12 ₽/шт", tag: "" },
  { id: 39, category: "fastener", name: "Гвоздь строительный", spec: "ГОСТ 4028-63", sizes: "40–200 мм", price: "от 75 ₽/кг", tag: "" },
  { id: 40, category: "fastener", name: "Саморез кровельный", spec: "оцинк. с EPDM-шайбой", sizes: "4.8×35 – 6.3×150 мм", price: "от 2.5 ₽/шт", tag: "Популярно" },
  { id: 41, category: "fastener", name: "Проволока вязальная", spec: "ст3, ГОСТ 3282-74", sizes: "Ø 1.2–6 мм", price: "от 68 ₽/кг", tag: "" },
  // Цветной металлопрокат
  { id: 42, category: "color", name: "Труба медная", spec: "М1, ГОСТ 617-2006", sizes: "Ø 6–108 мм", price: "от 890 000 ₽/т", tag: "" },
  { id: 43, category: "color", name: "Лист алюминиевый", spec: "АМГ2, ГОСТ 21631-76", sizes: "1–10 мм × 1000–2000 мм", price: "от 310 000 ₽/т", tag: "Популярно" },
  { id: 44, category: "color", name: "Труба алюминиевая", spec: "АД31Т, ГОСТ 18482-79", sizes: "Ø 20–200 мм", price: "от 340 000 ₽/т", tag: "" },
  { id: 45, category: "color", name: "Лист латунный", spec: "Л63, ГОСТ 2208-2007", sizes: "0.5–10 мм × 600–2000 мм", price: "от 710 000 ₽/т", tag: "" },
  { id: 46, category: "color", name: "Прут алюминиевый", spec: "Д16, ГОСТ 21488-97", sizes: "Ø 10–200 мм, длина 6 м", price: "от 360 000 ₽/т", tag: "" },
  { id: 47, category: "color", name: "Полоса медная", spec: "М1, ГОСТ 1173-2006", sizes: "4×20 – 12×120 мм", price: "от 870 000 ₽/т", tag: "" },
  { id: 48, category: "color", name: "Уголок алюминиевый", spec: "АД31Т, ГОСТ 13737-90", sizes: "20×20 – 100×100 мм", price: "от 320 000 ₽/т", tag: "" },
  // Нержавеющий металлопрокат
  { id: 49, category: "stainless", name: "Лист нержавеющий х/к", spec: "AISI 304, ГОСТ 7350-77", sizes: "0.5–6 мм × 1000–2000 мм", price: "от 380 000 ₽/т", tag: "Популярно" },
  { id: 50, category: "stainless", name: "Лист нержавеющий г/к", spec: "AISI 316, ГОСТ 7350-77", sizes: "4–50 мм × 1000–2000 мм", price: "от 430 000 ₽/т", tag: "" },
  { id: 51, category: "stainless", name: "Труба нержавеющая бесшовная", spec: "AISI 304, ГОСТ 9941-81", sizes: "Ø 6–159 мм", price: "от 450 000 ₽/т", tag: "" },
  { id: 52, category: "stainless", name: "Труба нержавеющая сварная", spec: "AISI 304, ГОСТ 11068-81", sizes: "Ø 8–219 мм", price: "от 390 000 ₽/т", tag: "" },
  { id: 53, category: "stainless", name: "Прут нержавеющий", spec: "AISI 304, ГОСТ 2590-2006", sizes: "Ø 6–200 мм, длина 6 м", price: "от 420 000 ₽/т", tag: "" },
  { id: 54, category: "stainless", name: "Уголок нержавеющий", spec: "AISI 304, ГОСТ 8509-93", sizes: "20×20 – 100×100 мм", price: "от 480 000 ₽/т", tag: "" },
  { id: 55, category: "stainless", name: "Полоса нержавеющая", spec: "AISI 316L, ГОСТ 103-2006", sizes: "4×20 – 16×200 мм", price: "от 460 000 ₽/т", tag: "" },
];
...
const PRICE_LISTS = [
  ...
  { name: "Профлист", date: "апрель 2026", file: "#" },
  { name: "Метизная продукция", date: "апрель 2026", file: "#" },
  { name: "Цветной металлопрокат", date: "апрель 2026", file: "#" },
  { name: "Нержавеющий прокат", date: "апрель 2026", file: "#" },
];
